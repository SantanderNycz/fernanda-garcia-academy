...
const TRANSLATIONS = {
  pt: {
    ...
    'cursos.lash.desc': 'O guia completo para curvar, projetar e alinhar cílios naturais, da química dos produtos à prática de bancada. Resultado dura 45 – 60 dias.',
    ...
    'cursos.brow.desc': 'Laminação e design visagista em um único curso. Sobrancelhas personalizadas para cada rosto, com resultado duradouro de 4 a 6 semanas.',
    ...
    'cursos.coreano.desc': 'Para profissionais que já dominam o método tradicional. Técnica de aplicação direta com maior velocidade, controle e segurança no procedimento.',
    ...
    'cursos.design.desc': 'Mapeamento facial, técnicas de design e pigmentação para criar sobrancelhas personalizadas e harmoniosas. Conteúdo em desenvolvimento.',
    ...
    'lash.sub': 'Aprenda a curvar, projetar e alinhar cílios naturais com técnica, segurança e resultado duradouro.',
    'lash.h2': 'O que é o <em>Lash Lifting?</em>',
    'lash.p1': 'O Lash Lifting é um procedimento estético inovador que curva, projeta e alinha os fios naturais dos cílios, sem a necessidade de aplicar extensões artificiais ou alongamentos.',
    'lash.p2': 'Através de uma técnica precisa e do uso de produtos específicos que respeitam a saúde capilar, o procedimento faz com que os cílios naturais da cliente aparentem ser consideravelmente maiores, mais densos e organizados. O resultado é um olhar marcante, expressivo e com um efeito "cílios de boneca" que dura de 45 a 60 dias.',
    ...
    'brow.sidebar.note': 'Entraremos em contato pelo WhatsApp com todos os detalhes.',
    ...
    'coreano.sub': 'Para profissionais que já dominam a técnica tradicional e querem elevar eficiência, velocidade e segurança ao próximo nível.',
    'coreano.h2': 'O Lash Lifting no <em>Método Coreano</em>',
    'coreano.p1': 'O Lash Lifting no Método Coreano é uma especialização avançada voltada para profissionais que já dominam a técnica tradicional e desejam alcançar o próximo nível de eficiência e controle em mesa. O resultado estético entrega o mesmo visual impecável e de alto impacto do método convencional, fios curvados, alinhados e destacados, mas a grande revolução está na dinâmica do atendimento e na segurança do processo.',
    'coreano.aviso': 'Este curso é voltado exclusivamente para profissionais que já possuem experiência no método tradicional de Lash Lifting. O pré-requisito é a bagagem prática adquirida no método convencional.',
    'coreano.intro': 'Esta proposta avançada destaca-se por três pilares comerciais e técnicos indispensáveis:',
    'coreano.p1.num': '01',
    'coreano.p1.title': 'Faturamento Escalável pelo Menor Tempo',
    'coreano.p1.desc': 'Com uma metodologia ágil, o tempo de procedimento é significativamente reduzido, permitindo que você aumente o fluxo de atendimentos diários e multiplique o faturamento.',
    'coreano.p2.num': '02',
    'coreano.p2.title': 'Controle Direto e Segurança Extrema',
    'coreano.p2.desc': 'O método baseia-se em uma aplicação onde os fios são atingidos pelo produto de forma direta, possibilitando controle muito maior sobre a ação da química, tornando o procedimento extremamente seguro e previsível.',
    'coreano.p3.num': '03',
    'coreano.p3.title': 'Exigência de Expertise Prática',
    'coreano.p3.desc': 'Por se tratar de uma técnica de alta precisão e agilidade, este não é um curso para iniciantes. Para se especializar no Método Coreano, o profissional já deve dominar o método tradicional.',
    ...
    'coreano.sidebar.note': 'Entraremos em contato pelo WhatsApp com todos os detalhes.',
  },
  en: {
    'nav.sobre': 'About',
    ...
    'cursos.lash.desc': 'The complete guide to curling, projecting and aligning natural lashes — from product chemistry to hands-on practice. Results last 45–60 days.',
    ...
    'cursos.brow.desc': 'Lamination and facial design in one course. Personalised eyebrows for every face, with long-lasting results of 4 to 6 weeks.',
    ...
    'cursos.coreano.desc': 'For professionals who already master the traditional method. Direct-application technique with greater speed, control and safety.',
    ...
    'cursos.design.desc': 'Facial mapping, design techniques and pigmentation to create personalised, harmonious eyebrows. Content in development.',
    ...
    'lash.sub': 'Learn to curl, project and align natural lashes with technique, safety and long-lasting results.',
    'lash.h2': 'What is <em>Lash Lifting?</em>',
    'lash.p1': 'Lash Lifting is an innovative aesthetic procedure that curls, projects and aligns natural lashes — no extensions or artificial lengthening required.',
    'lash.p2': 'Using a precise technique and specific products that respect lash health, the procedure makes the client\'s natural lashes appear significantly longer, denser and more defined. The result is a striking, expressive look with a "doll lash" effect that lasts 45 to 60 days.',
    ...
    'lash.sidebar.note': 'We will get in touch via WhatsApp with all the details.',
    // brow-lamination.html
    'brow.back': 'All courses',
    'brow.tag': 'Complete course',
    'brow.h1': 'Brow Lamination +<br /><em>Strategic Design</em>',
    'brow.sub': 'Redefine, align and design personalised eyebrows — combining lamination and facial mapping for results lasting 4 to 6 weeks.',
    'brow.h2': 'What is <em>Brow Lamination</em> with Strategic Design?',
    'brow.p1': 'Brow Lamination is an advanced aesthetic procedure that redefines, aligns and disciplines the natural brow hairs. Through an alignment technique and the use of specific products that safely alter the hair structure, the hairs become pliable and can be styled in any desired direction.',
    'brow.p2': 'The key differentiator of this procedure is its combination with Strategic Eyebrow Design — our signature approach. Far from ready-made templates or artificial shapes, this design style is fully personalised for each face, respecting natural lines, anatomy and the unique identity of each client, with an absolute focus on a natural look.',
    'brow.p3': 'The result is an immediate visual effect of fuller, more robust and symmetrical eyebrows — the perfect solution both for covering gaps and taming misaligned or downward-growing hairs. By combining the pliability of lamination with the facial mapping of strategic design, the procedure delivers everything from the modern fluffy brow look to a more classic, sophisticated and discreet style, always tailored to the client and lasting 4 to 6 weeks.',
    ...
    'brow.sidebar.note': 'We will get in touch via WhatsApp with all the details.',
    // lash-lifting-coreano.html
    'coreano.back': 'All courses',
    'coreano.tag': 'Advanced specialisation course',
    'coreano.h1': 'Lash Lifting<br /><em>Korean Method</em>',
    'coreano.sub': 'For professionals who already master the traditional technique and want to take efficiency, speed and safety to the next level.',
    'coreano.h2': 'Lash Lifting — the <em>Korean Method</em>',
    'coreano.p1': 'The Korean Method Lash Lifting is an advanced specialisation for professionals who already master the traditional technique and wish to reach the next level of efficiency and control. The aesthetic result delivers the same impeccable, high-impact look as the conventional method — curled, aligned and defined lashes — but the real revolution lies in the dynamics of the service and the safety of the process.',
    'coreano.aviso': 'This course is exclusively for professionals who already have experience with the traditional Lash Lifting method. Hands-on experience with the conventional method is a prerequisite.',
    'coreano.intro': 'This advanced approach stands out for three essential commercial and technical pillars:',
    'coreano.p1.num': '01',
    'coreano.p1.title': 'Scalable Revenue Through Reduced Time',
    'coreano.p1.desc': 'With an agile methodology, procedure time is significantly reduced, allowing you to increase the number of daily appointments and multiply your revenue.',
    'coreano.p2.num': '02',
    'coreano.p2.title': 'Direct Control and Extreme Safety',
    'coreano.p2.desc': 'The method is based on direct product application to the lashes, enabling far greater control over the chemical action — making the procedure extremely safe and predictable.',
    'coreano.p3.num': '03',
    'coreano.p3.title': 'Practical Expertise Required',
    'coreano.p3.desc': 'As a high-precision, high-speed technique, this is not a course for beginners. To specialise in the Korean Method, the professional must already master the traditional method.',
    ...
    'coreano.sidebar.note': 'We will get in touch via WhatsApp with all the details.',
  },
};
...
(function initCarousel() {
  ...
  function getCardW()  { return isDesktop() ? 260 : 200; }
  ...
  function makeCard(item, active) {
    ...
    if (item.type === "video") {
      ...
      if (active) { video.autoplay = true; video.controls = true; }
  ...
  // ── Helpers partilhados ─────────────────────────
  function allCards(track) { return [...track.querySelectorAll(".video-card")]; }
  ...
  function setupDesktop(track, N) {
    ...
    let tx0 = 0, ty0 = 0, tDragging = false;
    carousel.addEventListener("touchstart", (e) => {
      tx0 = e.touches[0].clientX; ty0 = e.touches[0].clientY; tDragging = false;
    }, { passive: true });
    carousel.addEventListener("touchmove", (e) => {
      const dx = Math.abs(e.touches[0].clientX - tx0);
      const dy = Math.abs(e.touches[0].clientY - ty0);
      if (dx > dy && dx > 8) { tDragging = true; e.preventDefault(); }
    }, { passive: false });
    ...
    function init() { applyPos(track, current, false); activateCard(track, current); }
    ...
    if (section) {
      new IntersectionObserver(([entry]) => {
        if (!entry.isIntersecting) {
          ...
          allCards(track)[current]?.querySelector("video")?.play().catch(() => {});
        }
  ...
  function setupMobile(track, total) {
    ...
    function activateIdx(idx) {
      allCards(track).forEach((c, i) => {
        ...
        const v = c.querySelector("video");
        if (!v) return;
        if (active) { v.controls = true; v.play().catch(() => {}); }
        else { v.pause(); v.controls = false; }
      });
    }
    ...
    track.addEventListener("transitionend", (e) => {
      ...
      if (trackIdx === 0) {
        trackIdx = total; setPos(trackIdx, false); activateIdx(trackIdx);
      } else if (trackIdx === total + 1) {
        trackIdx = 1; setPos(trackIdx, false); activateIdx(trackIdx);
      }
      isAnimating = false;
    });
    ...
    function initPosition() { setPos(trackIdx, false); activateIdx(trackIdx); }
    document.readyState === "complete" ? initPosition() : window.addEventListener("load", initPosition, { once: true });
    ...
    if (section) {
      new IntersectionObserver(([e]) => {
        if (!e.isIntersecting) {
          ...
          allCards(track)[trackIdx]?.querySelector("video")?.play().catch(() => {});
        }
      }, { threshold: 0.2 }).observe(section);
    }
  }
